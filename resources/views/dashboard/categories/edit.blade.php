...
<div class="col-lg-8">
    <form method="POST" action="/dashboard/categories/{{ $category->id }}" class="mb-5" enctype="multipart/form-data">
        ...
        {{-- title --}}
        <div class="mb-3">
          <label for="name" class="form-label @error('name')@enderror is-invalid">name</label>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('slug')@enderror" id="slug" name="slug" required value="{{ old('slug', $category->slug) }}" >
          @error('slug')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
